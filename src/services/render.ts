...
<head>
  ...
  <title>${title}</title>
  <meta name="description" content="TypeScript studio for catalog schema governance, merchandising dependencies, release-safe attribute changes, and buyer-facing product-data operations. Operator surface in the Kinetic Gain Suite." />
  ...
  <link rel="canonical" href="https://catalog.kineticgain.com/" />
  <link rel="icon" type="image/svg+xml" href="${KG_FAVICON_DATA_URI}" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Kinetic Gain" />
  <meta property="og:title" content="${title}" />
  <meta property="og:url" content="https://catalog.kineticgain.com/" />
  <meta property="og:description" content="TypeScript studio for catalog schema governance, merchandising dependencies, release-safe attribute changes, and buyer-facing product-data operations. Operator surface in the Kinetic Gain Suite." />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="${title}" />
  <meta name="twitter:description" content="TypeScript studio for catalog schema governance, merchandising dependencies, release-safe attribute changes, and buyer-facing product-data operations. Operator surface in the Kinetic Gain Suite." />
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"ProfessionalService","@id":"https://catalog.kineticgain.com/#service","name":"Kinetic Gain — TypeScript studio for catalog schema governance, merchandising dependencies, release-safe attribute changes, and buyer-facing product-data operations","url":"https://catalog.kineticgain.com/","areaServed":"United States","description":"TypeScript studio for catalog schema governance, merchandising dependencies, release-safe attribute changes, and buyer-facing product-data operations. Operator surface in the Kinetic Gain Suite."},{"@type":"WebSite","@id":"https://catalog.kineticgain.com/#website","url":"https://catalog.kineticgain.com/","name":"TypeScript studio for catalog schema governance, merchandising dependencies, release-safe attribute changes, and buyer-facing product-data operations","publisher":{"@type":"Organization","name":"Kinetic Gain LLC"}}]}</script>
  <style>${KG_STYLE01_CSS}${KG_COMPAT_CSS}</style>
</head>
<body>
  <header>
    <div class="wrap nav">
      <a class="kg-logo" href="/" aria-label="Kinetic Gain — TypeScript studio for catalog schema governance, merchandising dependencies, release-safe attribute changes, and buyer-facing product-data operations">
        ${KG_MARK_SVG}
        <span class="kg-word">Kinetic Gain</span>
      </a>
      <nav class="nav-links" id="primaryNav">
        <a href="/schema-lane">Schema Lane</a>
        <a href="/dependency-risks">Dependency Risks</a>
    ...
    <div class="wrap">
      <div class="foot-top">
        <div>
          ...
          <p class="foot-tag">TypeScript studio for catalog schema governance, merchandising dependencies, release-safe attribute changes, and buyer-facing product-data operations — operator surface in the Kinetic Gain Suite. Static demo data; no live calls.</p>
        </div>
        <div class="foot-cols">
          <div class="foot-col">
            <h4>Estate</h4>
          ...
          <div class="foot-col">
            <h4>This surface</h4>
            <a href="https://github.com/mizcausevic-dev/catalog-schema-governance-studio">GitHub repo</a>
          </div>
        </div>
      </div>
      <div class="foot-bot">
